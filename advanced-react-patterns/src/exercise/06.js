...
// function useWarning(isManaged, managedHandler) {
//   if (isManaged != null && !managedHandler) {
//     console.warn('You cannot pass a value without providing a value handler')
//   }
...
function useToggle({
  ...
  // const {on} = state
  const on = controlledOn != null ? controlledOn : state.on

...
//     imgSrcResourceCache[src] = createResource(preloadImage(src))
//   }
//   let srcResource = imgSrcResourceCache[src]
//   return <img src={srcResource.read()} alt={alt} {...props} />
// }
...
function getPokemonResource(name) {
  ...
  if (!resource) {
    let data = createPokemonResource(lowerName)
    let image = createResource(preloadImage(getImageUrlForPokemon(lowerName)))
    resource = {data, image}
